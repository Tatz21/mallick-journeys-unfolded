      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><span className="text-primary-foreground/80">Flight Booking</span></li>
              <li><span className="text-primary-foreground/80">Hotel Reservations</span></li>
              <li><span className="text-primary-foreground/80">Tour Packages</span></li>
              <li><span className="text-primary-foreground/80">Car Rentals</span></li>
              <li><span className="text-primary-foreground/80">Travel Insurance</span></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-primary-foreground/80 text-sm">Phoenix Business Center, Kolkata - 700001</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-4 w-4 text-primary-foreground/60" />
                <span className="text-primary-foreground/80 text-sm">+91 93301 02817</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-4 w-4 text-primary-foreground/60" />
                <span className="text-primary-foreground/80 text-sm">travel@phoenixrealesthatic.com</span>
              </div>
            </div>
          </div>
        </div>
